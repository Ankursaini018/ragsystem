...
const Landing = () => {
  return (
    <div className="min-h-screen bg-gradient-dark">
      ...
      {/* Hero Section */}
      <section id="home" className="relative z-10 py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            <span className="text-gradient">Chat with Your Documents</span>
          </h1>
      ...
      {/* About Section */}
      <section id="about" className="relative z-10 py-24 px-4 border-t border-border/50">
      ...
      <section id="how-it-works" className="relative z-10 py-24 px-4 border-t border-border/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
